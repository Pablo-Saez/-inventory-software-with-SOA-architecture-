...
try:
    ...
    message = b'00010sinitadpbo' #adpbo = registrar stock
    logging.info('sending {!r}'.format(message))
    sock.sendall(message)

    while True:
        logging.info("Waiting for transactions add productos bodega")
        amount_received = 0
        ...
        while amount_received < amount_expected:
            ...
            try:
                ...
                formatted_data = f"12 {id_product} {fechaentrada} {cantidadnew} "
                ...
                message = '00015adpboaddprodtbd'.encode()
                logging.info('sending {!r}'.format(message))                    
                sock.sendall(message)
